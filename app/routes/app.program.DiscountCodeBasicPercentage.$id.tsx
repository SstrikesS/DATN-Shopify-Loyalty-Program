...
export async function loader({request, params}: LoaderFunctionArgs) {
    ...
    if (store instanceof Store) {
        const type = "DiscountCodeBasicPercentage";
        const icon = 'https://cdn-icons-png.flaticon.com/32/879/879757.png';
        const id = params.id;
...
export default function NewReward() {
    ...
    useEffect(() => {
        if (!isPositiveFloat(discountValue)) {
            ...
            setDiscountValueError('Discount value must be between 0 and 100')
        } else {
