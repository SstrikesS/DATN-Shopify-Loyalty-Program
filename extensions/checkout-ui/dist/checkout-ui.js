...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    const [isFetching, setIsFetching] = (0, import_react20.useState)(true);
    const [reward, setReward] = (0, import_react20.useState)([]);
    const [adding, setAdding] = (0, import_react20.useState)(false);
    const appMetafields = useAppMetafields();
    const applyDiscountCodeChange = useApplyDiscountCodeChange();
    const handleDiscountCodeAdd = (code) => __async(this, null, function* () {
      setAdding(true);
    ...
    if (isFetching) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "loose", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          ...
          {
            level: 2,
            children: reward.length > 0 ? "Your available coupons" : "You don't have any coupons yet!"
          }
        ),
        reward.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { spacing: "loose", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { spacing: "loose", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          InlineLayout2,
          {
            spacing: "base",
            columns: [64, "fill", "auto"],
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "none", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "medium", emphasis: "strong", children: item.title }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { appearance: "subdued", children: item.code })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                Button2,
                {
